...
import com.example.example_project_modul_5in_kotlin.activity.adapter.ItemAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initRecyclerView(list: ArrayList<ItemModel>) {
    ...
    private fun getData(): ArrayList<ItemModel> {
        val list: ArrayList<ItemModel> = ArrayList()
        list.add(ItemModel(R.drawable.ic_baseline_favorite_border_24,"deferferfewgrtgtrgtr"))
        list.add(ItemModel(R.drawable.ic_baseline_add_to_photos_24,"derfrtgtrgwqswdwe"))
        list.add(ItemModel(R.drawable.ic_baseline_notifications_none_24,"dewfgythtynymnjyjyu"))
        list.add(ItemModel(R.drawable.ic_baseline_chat_bubble_outline_24,"asadrefrefrbhjnyu"))
    ...
    private fun getBottomDotsLayout(count: Int): LinearLayout? {
        ...
        l1.layoutParams = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
